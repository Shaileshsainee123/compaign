              ...
              <div className="bg-card border border-border rounded-lg p-8">
                ...
                <div className="w-full bg-muted rounded-full h-2 overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${Math.min(insights.ctr * 10, 100)}%`,
                    }}
                  />
                </div>
              ...
              <div className="bg-card border border-border rounded-lg p-8">
                ...
                <div className="w-full bg-muted rounded-full h-2 overflow-hidden">
                  <div
                    className="bg-primary h-full rounded-full"
                    style={{
                      width: `${Math.min((insights.cpc / 10) * 100, 100)}%`,
                    }}
                  />
                </div>

                <p className="text-xs text-muted-foreground mt-3">
                  {formatCurrency(insights.spend)} spent for{" "}
              ...
              <div className="bg-card border border-border rounded-lg p-8">
                ...
                <div className="w-full bg-muted rounded-full h-2 overflow-hidden">
                  <div
                    className="bg-primary h-full rounded-full"
                    style={{
                      width: `${Math.min(insights.conversion_rate * 10, 100)}%`,
                    }}
                  />
                </div>
            ...
            <div className="bg-gradient-to-br from-card to-muted/30 border border-border rounded-lg p-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-foreground">
                    {(insights.impressions /
                      Math.max(insights.conversions, 1)).toFixed(0)}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-foreground">
                    {(insights.clicks /
                      Math.max(insights.conversions, 1)).toFixed(1)}
                  </div>
                </div>
              </div>
            </div>
